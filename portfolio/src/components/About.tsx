  ...
  return (
    <section id="about" className="min-h-screen py-12 relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl border border-white/20 bg-gradient-to-br from-red-500/10 to-orange-500/10 backdrop-blur-sm p-3 md:p-5 shadow-2xl">
          ...
          >
            <div className="w-full flex items-center justify-center py-2 md:py-3">
